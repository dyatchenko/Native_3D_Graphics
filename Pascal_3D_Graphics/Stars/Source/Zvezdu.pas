...
var
 ...
 pxl:array[1..1000] of DPT;
{ pxl2:array[1..1000] of dpt;
 }
 xt,zt,yt: real;
...
begin
   ...
   if l>0 then pl[1].y:=round(-400*m*TCos(ay)/(l+700))+240;
   if l>0 then pl[1].x:=round(400*k1/(l+700))+320;

   if (l+700)>0 then PutPixel(pl[1].x,pl[1].y,color);
...
{  for i:=1 to 640 do begin
 ...
 { MakeCube(xf-111,yf,zf-101,200,200,200);
  ...
  for i:=1 to 1000 do begin
    pxl[i].x:=501-random(1000);
    pxl[i].y:=501-random(1000);
    pxl[i].z:=501-random(1000);
  end;

  {for i:=1 to 1000 do begin
    pxl2[i].x:=501-random(1000);
    pxl2[i].y:=501-random(1000);
    pxl2[i].z:=501-random(1000);
  end;
   }
  repeat
   ...
   { str(xo:3:3,s1);
    ...
    for i:=1 to 1000 do DrawPixel(pxl[i].x,pxl[i].y,pxl[i].z,white);
    {for i:=1 to 1000 do
      DrawPixel(pxl2[i].x,pxl2[i].y,pxl2[i].z,white);
      {if pxl2[i].z<-500 then pxl2[i].z:=500;
    end;       }
