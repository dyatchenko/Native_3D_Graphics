...
p,a,ay,hx,hy,u,p1,p2:real;
i,id,h,ut:integer;
s,s1,s2,s3,s4,s5,s6:string;
page:boolean;
c:char;
mx,my,mx0,my0:integer;
mas:Array[-50..50, -50..50] of dir;
...
begin
  ...
  m[1].rz:=round(zs*cos(a)+xs*sin(a));
  m[1].rx:=round(-zs*sin(a)+xs*cos(a));
  m[1].ry:=round(-m[1].rz*sin(ay)+ys*cos(ay));
  m[1].rz:=round(m[1].rz*cos(ay)+ys*sin(ay)+h);
  ...
  m[2].rz:=round(zs*cos(a)+xs*sin(a));
  m[2].rx:=round(-zs*sin(a)+xs*cos(a));
  m[2].ry:=round(-m[2].rz*sin(ay)+ys*cos(ay));
  m[2].rz:=round(m[2].rz*cos(ay)+ys*sin(ay)+h);
  ...
  m[3].rz:=round(zs*cos(a)+xs*sin(a));
  m[3].rx:=round(-zs*sin(a)+xs*cos(a));
  m[3].ry:=round(-m[3].rz*sin(ay)+ys*cos(ay));
  m[3].rz:=round(m[3].rz*cos(ay)+ys*sin(ay)+h);
...
{///////////////////////////////////////////////////////////////////////////////////////////////}
  ...
  if (m[3].sy<>m[1].sy) then begin
    ...
    if (m[3].rz)<>(m[1].rz)then
      if (m[3].rx-m[1].rx)>=(m[3].ry-m[1].ry)then
        begin
          lk3:=(m[3].rx-m[1].rx)/(m[3].rz-m[1].rz);
          ti:=(m[3].rx-lk3*m[3].rz);
          if ti<>0 then
            lk4:=0.0025/ti;
          lk3:=-lk4*400*lk3;
          mn:=true;
  ...
  if (m[1].sy<>m[2].sy) then begin
    ...
    if (m[2].rz)<>(m[1].rz)then
      if (m[2].rx-m[1].rx)>=(m[2].ry-m[1].ry)then
        begin
          lk1:=(m[2].rx-m[1].rx)/(m[2].rz-m[1].rz);
          ti:=(m[2].rx-lk1*m[2].rz);
          if ti<>0 then
            lk2:=0.0025/ti;
          lk1:=-lk2*400*lk1;
          n:=true;
    ...
    for i:=m[1].sy to m[2].sy do begin
      if (i>-240)and(i<240) then begin
        xn:=round(i*k1+k2);
        xk:=round(i*k3+k4);
        if n then wn:=xn*lk2+lk1 else wn:=i*lk2+lk1;
        if mn then wk:=xk*lk4+lk3 else wk:=i*lk4+lk3;
        if xn>xk then begin
          xn:=xn-xk;
          xk:=xk+xn;
          xn:=xk-xn;
  ...
  if (m[2].sy<>m[3].sy) then begin
    ...
    if (m[2].rz)<>(m[3].rz)then
      if (m[2].rx-m[3].rx)>=(m[2].ry-m[3].ry)then
        begin
          lk1:=(m[2].rx-m[3].rx)/(m[2].rz-m[3].rz);
          ti:=(m[3].rx-lk1*m[3].rz);
          if ti<>0 then
            lk2:=0.0025/ti;
          lk1:=-lk2*400*lk1;
          n:=true;
        ...
        begin
          lk1:=(m[2].ry-m[3].ry)/(m[2].rz-m[3].rz);
          ti:=(m[3].ry-lk1*m[3].rz);
          if ti<>0 then
            lk2:=0.0025/ti;
          lk1:=-lk2*400*lk1;
        end
...
begin
  MakeFillPlane(x,y,z,200,200,0,90,21);
  MakeFillTriangle(x,y,z,  x+100,y+150,z+100,  x+200,y,z,22);
  MakeFillTriangle(x,y,z,  x+100,y+150,z+100,  x,y,z+200,23);
  MakeFillTriangle(x,y,z+200,  x+100,y+150,z+100,  x+200,y,z+200,24);
  MakeFillTriangle(x+200,y,z, x+100,y+150,z+100, x+200,y,z+200,25);
end;
...
begin
  ...
  for i:=-50 to 50 do
    for id:=-50 to 50 do begin
      mas[i][id].z:=i*2;
      mas[i][id].x:=id*2;
      mas[i][id].y:=round(sqr(mas[i][id].x)/136-sqr(mas[i][id].z)/18);
    end;
  ...
  repeat
    ...
    for i:=-50 to 50 do
      for id:=-50 to 50 do
        Put3DPixel(mas[i][id].x,mas[i][id].y,mas[i][id].z,green);


    for i:=-50 to 50 do
      for id:=-50 to 50 do
        mas[i][id].y:=round(sqr(mas[i][id].x)/p1-sqr(mas[i][id].z)/p2);
   ...
   { MakeFillPiramide(100,20,100,100);
    }
    {makefilltriangle(-100,-100,110,300,-100,120,100,300,130,green);
    makefilltriangle(-100,round(130+100*cos(ut*pi/180)),round(340+100*sin(ut*pi/180)),450,round(-20+100*cos(ut*pi/180)),
      round(360+100*sin(ut*pi/180)),250,round(150+100*cos(ut*pi/180)),round(-100+100*sin(ut*pi/180)),lightgray);
    }
    Draw;
